...
videoID: "HDhFIRA-oZU"
faq:
  - question: "Τι είναι το ConFoot CFU;"
    answer: |
      Το ConFoot CFU είναι ένα ρυθμιζόμενο ποδί δοχείου που επιτρέπει την προσαρμογή του ύψους του δοχείου από το επίπεδο του εδάφους έως 1,5 μέτρο, χωρίς να απαιτείται πρόσθετος εξοπλισμός για τη διαχείριση του δοχείου.
  - question: "Πώς λειτουργεί το ConFoot CFU;"
    answer: |
